  ...
  return (
    <section className="relative isolate overflow-hidden border-b border-slate-300/60 bg-white pb-16 pt-28 md:pb-30 md:pt-40">
      ...
      <div className="mx-auto flex w-[min(1240px,calc(100%-1.5rem))] flex-col items-start">
        {/* <Eyebrow className="justify-start text-primary" showDash={false}>
          Services
        </Eyebrow> */}
        <DisplayTitle className="mt-3 max-w-5xl text-balance text-[#0f172f] md:text-5xl lg:text-6xl">
          Surface-specific cleaning services built for real property conditions.
        </DisplayTitle>
        <SectionLead className="mt-5 max-w-4xl text-slate-600">
          Explore pressure cleaning, acid washing, stain treatment, facade restoration, driveway refresh, and
          commercial site cleaning delivered with controlled process and consistent finish quality.
        </SectionLead>
